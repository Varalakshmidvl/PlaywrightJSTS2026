let sukumar_age = 18;
let SK_will_goa = Sukumar_age >= 18 ? "SK will go goa" : "No Goa";
console.log(SK_will_goa)
...
// Multiple Condition
let age = 26;
let is_Dev_goa = age > 26 ? "Yes, he will go" : "else he will not go";
console.log(is_Dev_goa);




let age_Dev = 45;
let is_Dev_d = age_Dev > 18 ? (age_Dev > 26 ? "Drink" : "No Drink") : "NO GOA";
console.log(is_Dev_d);
